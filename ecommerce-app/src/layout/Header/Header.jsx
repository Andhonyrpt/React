...
export default function Header() {
    ...
    const [user, setUser] = useState({
        name: "Andhony Palacios",
        email: "andhonyrpt@gmail.com",
    ...
    //Focus en búsqueda movil cuando se abre
    useEffect(() => {
    ...
    //Prevenir el scroll del body cuando el menú movil está abierto
    useEffect(() => {
        if (isMobileMenuOpen) {
                                ...
                                >
                                    ...
                                    <div className="user-text">
                                        <span className="greeting">
                                            {isAuthenticated ? `Hola ${user?.name.split(" ")[0] || "Usuario"}` : "Hola, Inicia sesión"}
                                        </span>
